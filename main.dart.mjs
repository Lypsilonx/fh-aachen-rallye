...
_1599: () => new Map(),
_1600: (x0,x1,x2) => x0.set(x1,x2),
_1601: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
_1602: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1602(f,arguments.length,x0,x1) }),
_1603: (x0,x1) => x0.call(x1),
_1604: (x0,x1) => new ZXing.BrowserMultiFormatReader(x0,x1),
...
_1608: x0 => x0.getVideoTracks(),
_1609: x0 => x0.getCapabilities(),
_1610: () => ({}),
_1611: x0 => x0.getSettings(),
_1612: x0 => x0.getSupportedConstraints(),
_1613: x0 => ({video: x0}),
_1614: x0 => ({facingMode: x0}),
_1615: (x0,x1) => x0.getUserMedia(x1),
_1616: (x0,x1) => x0.getItem(x1),
_1617: (x0,x1) => x0.removeItem(x1),
_1618: (x0,x1,x2) => x0.setItem(x1,x2),
_1622: x0 => x0.barcodeFormat,
_1623: x0 => x0.text,
_1624: x0 => x0.rawBytes,
_1625: x0 => x0.resultPoints,
...
_1735: (a, s) => a.join(s),
_1736: (a, s, e) => a.slice(s, e),
_1737: (a, s, e) => a.splice(s, e),
_1738: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1739: a => a.length,
_1741: (a, i) => a[i],
_1742: (a, i, v) => a[i] = v,
...
_1808: () => Date.now(),
_1809: () => new XMLHttpRequest(),
_1810: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1811: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1812: (x0,x1) => x0.send(x1),
_1813: x0 => x0.abort(),
_1814: x0 => x0.getAllResponseHeaders(),
_1819: (x0,x1) => x0.createElement(x1),
...
_1824: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1825: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1832: x0 => x0.attachStreamToVideo,
_1834: x0 => x0.decodeContinuously,
_1838: x0 => x0.reset,
_1840: x0 => x0.stopContinuousDecode,
_1842: x0 => x0.stream,
_1843: x0 => x0.videoElement,
_1844: x0 => x0.getVideoTracks(),
_1845: x0 => x0.getCapabilities(),
_1846: x0 => x0.getSettings(),
_1847: (x0,x1) => ({width: x0,height: x1}),
_1848: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
_1849: (x0,x1) => x0.key(x1),
_1850: x0 => x0.getCapabilities,
_1851: x0 => x0.facingMode,
_1868: (s, m) => {
          try {
...
_1873: x0 => x0.pop(),
_1877: (x0,x1,x2) => x0[x1] = x2,
_1879: o => o === undefined,
_1880: o => typeof o === 'boolean',
_1881: o => typeof o === 'number',
_1883: o => typeof o === 'string',
_1886: o => o instanceof Int8Array,
_1887: o => o instanceof Uint8Array,
_1888: o => o instanceof Uint8ClampedArray,
_1889: o => o instanceof Int16Array,
_1890: o => o instanceof Uint16Array,
_1891: o => o instanceof Int32Array,
_1892: o => o instanceof Uint32Array,
_1893: o => o instanceof Float32Array,
_1894: o => o instanceof Float64Array,
_1895: o => o instanceof ArrayBuffer,
_1896: o => o instanceof DataView,
_1897: o => o instanceof Array,
...
_2003: () => globalThis.window.flutterCanvasKit,
_2004: () => globalThis.window._flutter_skwasmInstance,
_2056: (x0,x1) => x0.withCredentials = x1,
_2058: x0 => x0.responseURL,
_2059: x0 => x0.status,
_2060: x0 => x0.statusText,
_2062: (x0,x1) => x0.responseType = x1,
_2063: x0 => x0.response,
_2114: (x0,x1) => x0.lang = x1,
_2143: x0 => x0.style,
_2202: (x0,x1) => x0.onerror = x1,
_2218: (x0,x1) => x0.onload = x1,
_2242: (x0,x1) => x0.onpause = x1,
_2244: (x0,x1) => x0.onplay = x1,
_2716: x0 => x0.videoWidth,
_2717: x0 => x0.videoHeight,
_2782: (x0,x1) => x0.controls = x1,
_3388: (x0,x1) => x0.src = x1,
_3390: (x0,x1) => x0.type = x1,
_3394: (x0,x1) => x0.async = x1,
_3396: (x0,x1) => x0.defer = x1,
_3398: (x0,x1) => x0.crossOrigin = x1,
_3875: () => globalThis.window,
_3941: x0 => x0.navigator,
_4205: x0 => x0.localStorage,
_4316: x0 => x0.mediaDevices,
_4552: x0 => x0.length,
_6658: () => globalThis.document,
_6753: x0 => x0.head,
_7102: (x0,x1) => x0.id = x1,
_10054: x0 => x0.facingMode,
_10268: x0 => x0.width,
_10270: x0 => x0.height,
_10276: x0 => x0.facingMode,
_11811: (x0,x1) => x0.height = x1,
_12005: (x0,x1) => x0.objectFit = x1,
_12135: (x0,x1) => x0.pointerEvents = x1,
_12433: (x0,x1) => x0.transform = x1,
_12437: (x0,x1) => x0.transformOrigin = x1,
_12501: (x0,x1) => x0.width = x1,
_13633: x0 => x0.x,
_13634: x0 => x0.y,
_13635: x0 => x0.message
    };
