...
abstract class FunPageState<T extends FunPage> extends TranslatedState<T>
  ...
  Widget build(BuildContext context) {
    return Title(
      title: "FH Aachen Rallye - ${translate(title)}",
      color: widget.color.withSaturation(0.8),
      child: Scaffold(
        appBar: FunAppBar(
          widget.color,
                                    ...
                                    (page) {
                                      ...
                                      return ElevatedButton(
                                        ...
                                        onPressed: isCurrentPage
                                            ? null
                                            : () {
                                                int fromIndex = FHAachenRallye
                                                    .pages
                                                    .indexWhere((p) =>
                                                        p.navPath ==
                                                        widget.navPath);
                                                int toIndex = FHAachenRallye
                                                    .pages
                                                    .indexWhere((p) =>
                                                        p.navPath ==
                                                        page.navPath);
